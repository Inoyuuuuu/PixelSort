...
#### Animation
The animation works by saving "snapshots" of the image after fixed iterations of the sorting algorithm, which then are played back after the pixels were sorted.
This can be disabled with the "isAnimationEnabled" variable.\
